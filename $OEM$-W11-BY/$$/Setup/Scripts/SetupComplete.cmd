...
regedit /s %cdrom%\1_Progs\DM-UAC-ON.reg
...
REG ADD %KEY%\110 /V 1 /D "%cdrom%\1_Progs\7z2107-x64.exe /S" /f
...
;REG ADD %KEY%\200 /VE /D "TWEAKS reg" /f
;REG ADD %KEY%\200 /V 1 /D "%windir%\setup\scripts\post2.cmd" /f

REG ADD %KEY%\260 /VE /D "TASKS off" /f
REG ADD %KEY%\260 /V 1 /D "%cdrom%\1_Progs\DM-Tweaks.cmd" /f
REG ADD %KEY%\265 /V 1 /D "%cdrom%\1_Progs\DM-Cursors.cmd" /f

REG ADD %KEY%\300 /VE /D "CLEANUP" /f
REG ADD %KEY%\300 /V 1 /D "%windir%\setup\scripts\Cleanup.cmd" /f

REG ADD %KEY%\800 /VE /D "Final reboot" /f
