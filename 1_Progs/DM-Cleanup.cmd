...
title 					ОЧИСТКА мусора @ DM 2022
cls

@echo	* Удоляем не нужные папки 
@echo	==============================
...
IF EXIST %SystemRoot%\SYSTEM32\cleanmgr.exe START /WAIT cleanmgr /sagerun:1358 /d c
@echo  Done.
...
@echo.
@echo.
@echo.	*** Убираем ппиложения  ***
powershell %cdrom%\1_Progs\DM-PS-APPS.PS1
@echo  Done.
@echo	==============================
timeout /t 5 > nul
